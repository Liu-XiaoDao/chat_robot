class LinksController < ApplicationController
  ...
  def display_list
    @links = Link.all.where(is_able: true).order(:display_order)
    render layout: false
  end
  ...
  def update
    ...
    @link.is_able = params[:link][:is_able]
  ...
  private
    def category_params
      params.require(:link).permit(:title, :url_link, :icon, :display_order, :is_able)
    end
end
