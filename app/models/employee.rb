class Employee < ApplicationRecord
  ...
  # 金点子相关
  GoldenIdeaMembers =  ["任帆", "卢兴潮", "魏力", "何沙", "胡灶顺", "徐梦婷", "陈艳莉", "路传伟", "郭森良", "曾鹏", "杨娜", "葛江燕", "张鑫", "谷丽娟", "邢天棋", "梅慧敏", "袁冰", "邵丹平", "陈俊刚", "黄磊", "钱晶", "张晶晶", "王慧", "应宇倩", "童川", "方雄", "Brian Hulsebus", "Lisong Guo", "郑伊婷", "刘春良"]

  # 打分的人
  GoldenIdeaScoreMembers =  ["钱晶", "徐梦婷", "赵威", "路传伟", "应宇倩", "张晶晶", "童川", "邢天棋", "曾鹏", "陈艳莉", "何沙", "卢兴潮", "任帆", "田斌", "王慧", "张鑫", "王标", "张承丽", "马纯", "庄海霁", "陈俊刚", "于君丽", "金钱斌", "陈卿", "刘青新", "葛挺", "方玮", "沈薇薇", "谢雯", "郭献强", "李晓丽", "谭兴梅", "张昕霞", "马妍", "张扬扬 Adam Zhang", "蒋忠根", "方雄", "胡勇", "Brian Hulsebus", "Lisong Guo", "郑伊婷", "刘春良"]
