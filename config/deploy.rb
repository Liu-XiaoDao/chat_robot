...
set :linked_dirs, fetch(:linked_dirs) + %w{public/uploads public/images public/images/cover}
set :linked_files, fetch(:linked_files, []).push('config/database.yml', 'config/secrets.yml', 'config/email.yml', 'config/dingconfig.yml', 'config/filecache.yml')

set :config_dirs, %W{config config/environments/#{fetch(:stage)} public/system public/uploads}
set :config_files, %w{config/database.yml config/secrets.yml  config/email.yml config/dingconfig.yml config/filecache.yml}
